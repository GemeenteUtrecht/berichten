...
class Organisatie implements StringableInterface
{
	...
	/**
	 * Sjablonen die bij deze organisatie horen
	 *
	 * @var \Doctrine\Common\Collections\Collection|\App\Entity\Sjabloon[]|null
	 *
	 * @ORM\OneToMany(
	 * 		targetEntity="\App\Entity\Sjabloon",
	...
	/**
	 * Berichten die bij deze organisatie horen
	 *
	 * @var \Doctrine\Common\Collections\Collection|\App\Entity\Bericht[]|null
	 *
	 * @ORM\OneToMany(
	 * 		targetEntity="\App\Entity\Bericht",
	 * 		mappedBy="bronOrganisatie")
	 *
	 */
	public $berichten;
